...
export const GRPC_CHALLENGE_PHASE_SERVER_HOST = <string>process.env.GRPC_CHALLENGE_PHASE_SERVER_HOST;
export const GRPC_CHALLENGE_PHASE_SERVER_PORT = <string>process.env.GRPC_CHALLENGE_PHASE_SERVER_PORT;
...
assert(GRPC_CHALLENGE_PHASE_SERVER_HOST, "GRPC_CHALLENGE_PHASE_SERVER_HOST is not defined");
assert(GRPC_CHALLENGE_PHASE_SERVER_PORT, "GRPC_CHALLENGE_PHASE_SERVER_PORT is not defined");